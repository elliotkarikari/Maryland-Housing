...
**Status**: Historical (superseded by executed cleanup runs)

> Historical planning artifact: this document reflects repository state as of January 30, 2026.  
> Some path references (for example legacy `api/` commands) are retained for historical context and are no longer canonical.  
> Use current docs instead: `docs/README.md`, `docs/api/API_REFERENCE.md`, `docs/audits/2026-02-engineering-audit.md`, and `docs/audits/2026-02-file-structure-cleanup.md`.
