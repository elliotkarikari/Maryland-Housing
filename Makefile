.PHONY: help install db-setup db-migrate ingest-all export serve test clean
...
help:
	...
	@echo "  make process        - Run scoring and classification"
	@echo "  make export         - Generate GeoJSON outputs"
...
process:
	@echo "Running normalization and scoring..."
	python -m src.processing.normalization
	python -m src.processing.scoring
	python -m src.processing.classification

export:
	@echo "Generating GeoJSON outputs..."
	python -m src.export.geojson
